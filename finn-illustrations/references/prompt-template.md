...
Composition:
{具体画面：Finn 在哪里、正在做什么、主要物件是什么、信息如何流动}
...
```text
Regenerate this illustration with the same core meaning and simple layout, but make Finn more central to the conceptual action. Finn should be doing the work that explains the idea, not standing beside the diagram. Keep it clean, sparse, hand-drawn, and not cute.
```
