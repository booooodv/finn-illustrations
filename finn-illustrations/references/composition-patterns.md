...
画法：左侧输入，中间 Finn 或怪机器处理，右侧输出，蓝色或黄色箭头表达主流向。

### 系统局部

适合：信息来源、过滤器、数据库、渲染器、agent 系统局部。

画法：只画 3-5 个核心模块，Finn 参与其中一个关键动作。

### 前后对比

适合：混乱/有序，手动/自动，分散/收拢，焦虑/稳定。

画法：左混乱，右稳定，中间箭头。Finn 可以在中间做转换动作。

### 角色状态

适合：用户痛点、创作者状态、工具太多、信息焦虑、卡住到跑起来。

画法：2-4 个小状态，每个状态一个短标注。Finn 的姿态要不同。
...
画法：一层层盒子，不要正式金字塔；Finn 在旁边搬砖、搭建或贴标签。

### 地图路线

适合：从想法到上线、用户路径、内容承接路径、学习路线。

画法：一条弯曲路径，少量节点，Finn 牵线、走路或修路。
...
3. 让 Finn 承担动作：不是站旁边，而是修机器、拉线、守门、搬运、修补、称重、扶梯子、记录、把东西塞进某个怪装置。
...
- 拉、扛、塞、捞、压、称、缝、剪、拧、守、推、接、拆、标记、回收、贴标签、修补、记录、搭桥。
- 动作要服务核心意思，不要为了怪而怪。

## 反复刻规则

不要复刻旧仓库示例构图。旧图只可作为原项目来源理解，不可作为 Finn 默认视觉参考。

同类主题也要换新隐喻。例如“承接路径”不一定画路线，可以画 Finn 把内容尾巴接到门把手；“一鱼多吃”不一定画鱼，可以画 Finn 把一个纸团压成几种形状。
